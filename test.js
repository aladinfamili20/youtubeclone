      ...
      try {
        await updateDoc(postRef, {
          comments: arrayUnion({
            ...
            profImage: userInfoProfileFetch.profImage,
...
const PostHeader = ({post})=>{
  ...
  return (     
    <View style={styles.postContainer} >
        ...
        <Image source={{uri : post.profImage}} style={styles.profileImage}/>
        </TouchableOpacity>
      ...
      post.comments.map((comment, index) => (
        <View key={index} style={{ flexDirection: 'row', alignItems: 'center' }}>
          <View style={styles.commenterContainer}>
            <TouchableOpacity onPress={() => navigateToProfile(post.uid)}>
            <Image source={{uri: comment.profImage}}  style={styles.CommentProfileImage}/>
            </TouchableOpacity>
